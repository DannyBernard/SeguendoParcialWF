<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CCliente.aspx.cs" Inherits="SegundoParcialWF.UI.Consulta.CCliente" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <div class="panel panel-primary">
        <div class="panel-heading">Consulta Clientes</div>
        <div class="panel-body">
            ...
            <div>
                ...
                <div class="col-md-4">
                    <asp:Button ID="BuscarButton" runat="server" Class="btn btn-success input-sm" Text="Buscar" >
                </div>
            </div>
            '
                ...
                <div class="modal-dialog" style="max-width: 600px!important; min-width: 300px!important">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <%--Viewer--%>
                            <rsweb:ReportViewer ID="ClienteReportViewer" runat="server" ProcessingMode="Remote" Height="500px" Width="500px">
