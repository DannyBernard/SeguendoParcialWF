<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CTransacciones.aspx.cs" Inherits="SegundoParcialWF.UI.Consulta.CTransacciones" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel panel-primary">
        <div class="panel-heading">Consulta Transaccion</div>
                ...
                <div class="modal-dialog" style="max-width: 600px!important; min-width: 300px!important">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <%--Viewer--%>
                            <rsweb:ReportViewer ID="TransaccionesReportViewer" runat="server" ProcessingMode="Remote" Height="500px" Width="500px">
